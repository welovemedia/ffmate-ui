...
const applyPreset = (preset: NewPreset) => {
    ...
    form.outputFile = preset.outputFile;
    ...
    <div class="grid grid-cols-1 gap-x-8 gap-y-8 pt-10 md:grid-cols-3">
        <div class="px-4 sm:px-0 flex flex-col space-y-2">
            ...
            <ul class="flex flex-col text-sm/6 text-gray-300">
                ...
                >
                    ...
                    >
                        <div class="flex flex-row space-x-2 items-center grow">
                            <PlusCircleIcon class="size-4 text-primary-400" />
                            <div class="flex flex-row space-x-2 items-center">
                                <span class="flex-grow">{{ preset.name }}</span>
                                <p
                                    class="text-xs text-gray-400 flex-shrink line-clamp-1"
                                >
                                    {{ preset.description }}
                                </p>
                            </div>
        ...
        >
            ...
            >
                ...
                <button
                    type="submit"
                    class="rounded-md bg-primary-500 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-primary-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-600"
                >
                    Create
                </button>
            </div>
